...
ShootingAgent = configure_agent(mc_simulation.ShootingAgent)  # pylint: disable=invalid-name
BanditAgent = configure_agent(mc_simulation.BanditAgent)  # pylint: disable=invalid-name
