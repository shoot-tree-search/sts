...
from alpacka.third_party.envs.bin_packing_environment import \
    BinPackingNewBinForInvalidAction


class BinPacking(base.ModelEnv):
    ...
    def __init__(
        ...
        """
        self._env = BinPackingNewBinForInvalidAction(
